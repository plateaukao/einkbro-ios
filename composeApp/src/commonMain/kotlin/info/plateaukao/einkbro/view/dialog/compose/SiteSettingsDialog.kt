    ...
    Column(
        ...
        Column(
            ...
            NestedNullableIntStepper(
                ...
                hint = stringResource(Res.string.site_force_viewport_width_hint),
            )
        ...
        Row(
            ...
            OutlinedButton(
                ...
                Text(stringResource(Res.string.reset_to_global), fontSize = 13.sp)
            }
            Button(
                onClick = {
...
private fun TranslationRow(
    ...
    Row(
        ...
        Spacer(Modifier.width(8.dp))
        Text(
            text = stringResource(Res.string.action_category_translation),
            modifier = Modifier.weight(1f),
            fontSize = 14.sp,
            color = color,
        )
