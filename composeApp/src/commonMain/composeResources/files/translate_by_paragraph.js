...
// once per element visited. That made a single scan quadratic, and nothing is requested
// until the scan finishes. textContent needs no layout, and normalizing whitespace
// reproduces innerText's collapsing for labels this short. Containers are rejected on
// child count first so we never materialize a large subtree's text just to compare it
...
(function () {
  ...
  //     so a page-full of them kept the loop fed indefinitely with no help from the site.
