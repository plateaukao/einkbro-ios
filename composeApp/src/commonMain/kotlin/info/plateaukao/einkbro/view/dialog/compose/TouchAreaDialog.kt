...
@Composable
fun TouchAreaDialogContent(
    onConfigActionsClick: (() -> Unit)? = null,
    onDismiss: () -> Unit = {},
) {
    ...
    TouchAreaContent(
        ...
        onConfigActionsClick = onConfigActionsClick
            ?: { EBToast.show(context, "would open gesture action settings") }
    )
}
    ...
    Column(Modifier.width(300.dp)) {
        Row(
            ...
            TouchAreaItem(
                ...
                iconResId = Res.drawable.ic_touch_left
            ) { onTouchTypeClick(Left) }
            TouchAreaItem(
                state = touchAreaType == MiddleLeftRight,
                iconResId = Res.drawable.ic_touch_middle_left_right
            ) { onTouchTypeClick(MiddleLeftRight) }
            TouchAreaItem(
                state = touchAreaType == Right,
                iconResId = Res.drawable.ic_touch_right
        ...
        ActionItem(
            Res.string.touch_aciton_settings,
        ...
        Row(Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.End) {
            Text(
                modifier = Modifier
                    .padding(10.dp)
                    .weight(1f),
                text = stringResource(Res.string.dialog_touch_area_enable),
...
fun ActionItem(
    ...
    Row(
        ...
        Icon(
            imageVector = vectorResource(Res.drawable.icon_arrow_right_gest),
            contentDescription = null,
            tint = MaterialTheme.colors.onBackground
        )
    }
