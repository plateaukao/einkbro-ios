...
import info.plateaukao.einkbro.resources.ic_add_folder
import info.plateaukao.einkbro.resources.menu_save_bookmark
...
/**
 * Edit dialog for a bookmark (title, url, parent folder). On Android this is
 * a ComposeDialogFragment; here the AlertDialog content is the entry itself.
 */
@Composable
    ...
    AlertDialog(
        ...
        text = {
            Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
                OutlinedTextField(
                    ...
                    label = { Text(stringResource(Res.string.dialog_title_hint)) },
                ...
                if (!bookmark.isDirectory) {
                    OutlinedTextField(
                        ...
                        label = { Text(stringResource(Res.string.dialog_url_hint)) },
                        modifier = Modifier.fillMaxWidth(),
                        colors = TextFieldDefaults.outlinedTextFieldColors(
                            textColor = MaterialTheme.colors.onBackground,
                        ),
                ...
                Row(
                    ...
                    Icon(
                        imageVector = vectorResource(Res.drawable.ic_add_folder),
        ...
        confirmButton = {
            TextButton(
                ...
                Text(
                    // android.R.string.ok has no CMP counterpart in this project
                    "OK",
                    color = MaterialTheme.colors.onBackground
                )
            }
